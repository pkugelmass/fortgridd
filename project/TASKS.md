...
5.  **Refined Testing Strategy (Adopted: 2025-04-09):**
 ...
 ### Ongoing / Refinement / Deferred Testing Tasks
 *(Tasks below may be addressed during the "Revisit & Improve Tests" step)*
 ...
 *   [ ] Add tests for initial AI state and properties. (Previously listed)
 *   [ ] Add unit tests for `calculateKnockbackDestination` helper function. (Added: 2025-04-09)
 *   [ ] Expand unit tests for AI state handlers (Engaging, Fleeing, etc.). (Added: 2025-04-09)
 ...
 *   [ ] **Clean Up TASKS.md:** Review completed tasks; consider moving them to a separate archive file (e.g., `project/COMPLETED_TASKS.md`) to keep the main file focused. (Added: 2025-04-09)
