...
### Comprehensive Unit Testing Overhaul (2025-04-10 to 2025-04-11)
*   [x] Systematically reviewed and rewrote/created unit tests module by module, focusing on core logic, edge cases, and failure states. Mocked dependencies as needed. Skipped trivial code and rendering logic per guidelines.
*   [x] Test `js/utils.js` (Completed: 2025-04-10)
*   [x] Test `js/config.js` (Completed: 2025-04-10)
*   [x] Test `js/gameState.js` (Completed: 2025-04-10)
*   [x] Test `js/map.js` (Completed: 2025-04-10)
*   [x] Test `js/player.js` & `js/playerActions.js` (Completed: 2025-04-10)
*   [x] Test `js/ai.js` (Core FSM Logic) (Completed: 2025-04-10)
*   [x] Test `js/ai/ai_perception.js` (Completed: 2025-04-10)
*   [x] Test `js/ai/ai_actions.js` (Completed: 2025-04-10)
*   [x] Test `js/ai/ai_movement.js` (Completed: 2025-04-10)
*   [x] Test `js/ai/state_exploring.js` (Completed: 2025-04-11)
*   [x] Test `js/ai/state_healing.js` (Completed: 2025-04-11)
*   [x] Test `js/ai/state_engaging_enemy.js` (Completed: 2025-04-11)
*   [x] Test `js/ai/state_fleeing.js` (Completed: 2025-04-11)
*   [x] Test `js/ai/state_seeking_resources.js` (Completed: 2025-04-11)
*   [x] Test `js/game.js` (Completed: 2025-04-11)
*   [x] Test `js/input.js` (Completed: 2025-04-11)
*   [x] Test `js/main.js` (Completed: 2025-04-11)

### Refactoring / Cleanup Tasks (2025-04-10 to 2025-04-11)
*   [x] Refactor `js/main.js` for separation of concerns (2025-04-10)
*   [x] Simplify `applyStormDamage` in `js/game.js` (2025-04-10)
*   [x] Decouple logging from UI updates in `js/game.js` (2025-04-10)
*   [x] Break down and refactor AI state handler modules for clarity and maintainability (2025-04-10, 2025-04-11)
*   [x] Standardize logging system and refactor all log calls (2025-04-10)
*   [x] Enhance test helpers and standardize test setup (2025-04-11)
*   [x] Refactor repetitive test setup boilerplate into helper functions (2025-04-10, 2025-04-11)
*   [x] Write essential unit tests for critical functions (2025-04-09)
*   [x] Review and break up overly long test modules (2025-04-11)
*   [x] Review AI state handler modules for length and complexity (2025-04-09)
*   [x] Investigate creating a shared `canMoveTo(unit, targetRow, targetCol)` utility function (2025-04-08)

### Discovered During Work (Completed Items)
*   [x] Fix player starting ammo initialization in js/main.js to correctly use PLAYER_START_AMMO from config.js (remove || 3 fallback). (Discovered: 2025-04-09, Completed: 2025-04-12)
*   [x] Modify findNearbyResource to ignore resources outside the safe zone. (Discovered: 2025-04-09, Completed: 2025-04-12)
*   [x] Modify getValidMoves to prevent movement into/within the storm (check safe zone). (Discovered: 2025-04-09, Completed: 2025-04-12)
